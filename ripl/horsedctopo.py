    ...
    def __init__(self, k = 4, speed = 1.0):
        ...
        for p in pods:
            ...
            for e in edge_sws:
                ...
                sw = SDNSwitch(long(edge_opts["dpid"], 16))
                self.g[edge_id] = []
                ...
                for a in agg_sws:
                    ...
                    if agg_id in self.switches():
                        ...
                        agg_sw = SDNSwitch(long(agg_opts["dpid"], 16))
            ...
            for a in agg_sws:
                ...
                for c in core_sws:
                    ...
                    if core_id not in self.switches():
                        core_sw = SDNSwitch(long(core_opts["dpid"], 16))
...
topo = FatTreeTopo()
# for info in topo.node_info:
#     print topo.node_info[info]

# # for core in topo.layer_nodes(topo.LAYER_CORE):
# #     print topo.down_edges(core)

# core_nodes = topo.layer_nodes(topo.LAYER_CORE) 
# agg_nodes = topo.layer_nodes(topo.LAYER_AGG) 
# edge_nodes = topo.layer_nodes(topo.LAYER_AGG)
# hosts = topo.layer_nodes(topo.LAYER_HOST) 
# for core in edge_nodes:
#     print topo.up_nodes(core)
#     print topo.down_nodes(core)
